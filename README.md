...
**正确在NVIM配置cscope**
由于在NVIM中去除了cscope的支持，因此我们需要使用一个插件来实现cscope的功能。我们可以使用：https://github.com/dhananjaylatkar/cscope_maps.nvim根据README中的说明进行配置。
我已经配置到lua/config/gutentags.lua中,目前可惜的是NVIM无法支持更强大的GTAGS。
